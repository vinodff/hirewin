...
export const PLAN_PRICES = {
  starter: { one_time_paise: 4900, label: '₹49 one-time' },
  pro: { monthly_paise: 16600, yearly_paise: 199000, label: '₹166/mo' },
  power: { monthly_paise: 33200, yearly_paise: 399000, label: '₹332/mo' },
};
