        ...
        >
          ...
          <Section title="2. Information We Collect">
            ...
            <ul className="list-disc list-inside space-y-1.5 pl-2">
              ...
              <li><strong className="text-white">Payment information:</strong> We do not store card details. Payments are processed securely by Cashfree.</li>
          ...
          <Section title="7. Third-Party Services">
            ...
            <ul className="list-disc list-inside space-y-1.5 pl-2">
              ...
              <li><strong className="text-white">Cashfree</strong> — payment processing</li>
