  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ background: '#080d1a' }}>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[600px] sm:w-[900px] h-[400px] sm:h-[600px] rounded-full opacity-25 animate-float"
          style={{ background: 'radial-gradient(ellipse, rgba(124,58,237,0.65) 0%, transparent 70%)', animationDuration: '9s' }} />
        <div className="absolute top-1/3 -right-40 w-[320px] sm:w-[520px] h-[320px] sm:h-[520px] rounded-full opacity-15 animate-float"
          style={{ background: 'radial-gradient(ellipse, rgba(59,130,246,0.8) 0%, transparent 70%)', animationDelay: '-3s', animationDuration: '11s' }} />
        <div className="absolute bottom-1/3 -left-40 w-[260px] sm:w-[420px] h-[260px] sm:h-[420px] rounded-full opacity-15 animate-float"
      ...
      {/* ══════════════════════════════════════════════════════
          HERO
      ══════════════════════════════════════════════════════ */}
      <section className="relative max-w-6xl mx-auto px-4 sm:px-6 pt-10 sm:pt-20 pb-6 text-center">
        ...
        <div
          className="relative inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full text-xs sm:text-sm font-medium mb-6 sm:mb-8 animate-slide-up-sm"
          style={{ background: 'rgba(124,58,237,0.12)', border: '1px solid rgba(124,58,237,0.3)', color: '#a78bfa' }}
        >
          <span className="relative flex w-2.5 h-2.5 shrink-0">
            <span className="absolute inset-0 rounded-full bg-purple-400"
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold text-white tracking-tight mb-4 sm:mb-6 leading-[1.08]">
        ...
        <p
          className="text-base sm:text-xl text-slate-400 max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed animate-slide-up-sm px-2"
        ...
        {/* CTAs */}
        <div
          className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-5 sm:mb-6 animate-slide-up-sm px-2"
          style={{ animationDelay: '0.62s' }}
        >
          <Link
            href="/analyze"
            className="shimmer-btn animate-glow-pulse w-full sm:w-auto flex items-center justify-center gap-2 text-white font-bold px-8 py-4 rounded-xl text-lg transition-all hover:scale-105 hover:brightness-110"
        ...
        {/* Trust pills */}
        <div
          className="flex items-center justify-center flex-wrap gap-3 sm:gap-6 text-xs sm:text-sm text-slate-500 mb-10 sm:mb-16 animate-slide-up-sm"
        ...
        {/* ── Before / After card ── */}
        <div
          className="relative max-w-3xl mx-auto rounded-2xl p-0.5 sm:p-1 animate-scale-in"
          style={{
        ...
        >
          ...
          <div className="absolute inset-0 rounded-2xl pointer-events-none"
            style={{ background: 'linear-gradient(90deg, transparent 50%, rgba(124,58,237,0.06) 100%)' }} />

          <div className="grid grid-cols-2 gap-0.5 sm:gap-1">
            {/* Before */}
            <div className="rounded-xl p-2.5 sm:p-5 text-left" style={{ background: '#08111f' }}>
              <div className="flex items-center justify-between mb-2 sm:mb-3">
                <span className="text-[10px] sm:text-xs font-semibold text-slate-500 uppercase tracking-wider">Before</span>
              ...
              <div className="flex items-center gap-1.5 sm:gap-3 mb-2 sm:mb-4">
                <div className="relative w-8 h-8 sm:w-12 sm:h-12 shrink-0">
                  <svg viewBox="0 0 36 36" className="w-8 h-8 sm:w-12 sm:h-12 -rotate-90">
                    <circle cx="18" cy="18" r="15.9" fill="none" stroke="rgba(255,255,255,0.05)" strokeWidth="3" />
                    <circle className="score-circle-34" cx="18" cy="18" r="15.9" fill="none"
                      stroke="#ef4444" strokeWidth="3" strokeLinecap="round" />
                  </svg>
                  <span className="absolute inset-0 flex items-center justify-center text-[9px] sm:text-xs font-bold text-red-400">34</span>
                </div>
                <div>
                  <div className="text-[10px] sm:text-xs font-semibold text-white">Arjun Sharma</div>
                  <div className="hidden sm:block text-xs text-slate-500">arjun@gmail.com</div>
                </div>
              </div>
              <div className="space-y-1 sm:space-y-1.5 text-[10px] sm:text-xs">
                <div className="font-semibold text-slate-600 uppercase tracking-wider text-[9px] sm:text-[10px]">Experience</div>
                <div className="text-slate-500">SE — Wipro Technologies</div>
                <div className="hidden sm:block text-slate-700">· Worked on Java modules</div>
                <div className="text-slate-700">· Attended daily scrums</div>
                <div className="hidden sm:block text-slate-700">· Fixed bugs in existing code</div>
                <div className="font-semibold text-slate-600 uppercase tracking-wider text-[9px] sm:text-[10px] mt-1.5 sm:mt-2">Skills</div>
                <div className="text-slate-700">Java, MySQL, HTML</div>
              </div>
            </div>

            {/* After */}
            <div
              className="rounded-xl p-2.5 sm:p-5 text-left relative overflow-hidden"
              style={{ background: 'rgba(124,58,237,0.07)', border: '1px solid rgba(124,58,237,0.18)' }}
            >
              <div className="absolute top-0 right-0 w-16 sm:w-28 h-16 sm:h-28 opacity-10 rounded-bl-full"
                style={{ background: 'linear-gradient(135deg, #7c3aed, #3b82f6)' }} />
              <div className="flex items-center justify-between mb-2 sm:mb-3">
                <span className="text-[10px] sm:text-xs font-semibold text-purple-400 uppercase tracking-wider">After</span>
                <span className="text-[10px] sm:text-xs font-bold px-1.5 sm:px-2 py-0.5 rounded-md"
              ...
              <div className="flex items-center gap-1.5 sm:gap-3 mb-2 sm:mb-4">
                <div className="relative w-8 h-8 sm:w-12 sm:h-12 shrink-0">
                  ...
                  <span className="absolute inset-0 flex items-center justify-center text-[9px] sm:text-xs font-bold text-green-400">91</span>
                </div>
                <div>
                  <div className="text-[10px] sm:text-xs font-semibold text-white">Arjun Sharma</div>
                  <div className="hidden sm:block text-xs text-slate-500">arjun@gmail.com</div>
              ...
              <div className="space-y-1 sm:space-y-1.5 text-[10px] sm:text-xs">
                <div className="font-semibold text-purple-400 uppercase tracking-wider text-[9px] sm:text-[10px]">Experience</div>
                <div className="text-slate-400">SE — Wipro Technologies</div>
                <div className="text-slate-300">· Built 4 Spring Boot µservices, ↓42% latency</div>
                <div className="hidden sm:block text-slate-300">· Automated 200+ tests, QA 5d → 1d</div>
                <div className="hidden sm:block text-slate-300">· Led 8 prod releases, 99.9% uptime</div>
                <div className="font-semibold text-purple-400 uppercase tracking-wider text-[9px] sm:text-[10px] mt-1.5 sm:mt-2">Skills</div>
                <div className="flex flex-wrap gap-1 mt-0.5">
                  {['Java', 'Spring Boot', 'AWS', 'MySQL'].map((s) => (
                    <span key={s} className="px-1 sm:px-1.5 py-0.5 rounded text-[9px] sm:text-[10px]"
        ...
        {/* Stats bar */}
        <div
          className="grid grid-cols-2 sm:grid-cols-4 gap-px mt-4 sm:mt-6 rounded-2xl overflow-hidden animate-scale-in"
          style={{
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-24">
        <ScrollReveal className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-slate-400 text-sm sm:text-base">One resume. Two versions. The gap is everything.</p>
        </ScrollReveal>

        <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 max-w-3xl mx-auto">
          {/* Before card */}
          <ScrollReveal direction="left">
            <div className="rounded-2xl p-5 sm:p-7 h-full" style={{ background: '#0f1629', border: '1px solid rgba(255,255,255,0.06)' }}>
              <div className="flex items-center justify-between mb-5 sm:mb-7">
                <div>
                  <div className="text-xs font-semibold text-slate-500 uppercase tracking-widest mb-1">BEFORE</div>
                  <div className="text-xs sm:text-sm text-slate-400">Generic resume</div>
                </div>
                <div className="text-4xl sm:text-5xl font-extrabold tabular-nums" style={{ color: '#ef4444' }}>34</div>
              </div>
            ...
            <div className="rounded-2xl p-5 sm:p-7 h-full relative overflow-hidden"
              ...
              <div className="flex items-center justify-between mb-5 sm:mb-7">
                <div>
                  ...
                  <div className="text-xs sm:text-sm text-slate-400">HireWin optimised</div>
                </div>
                <div className="text-4xl sm:text-5xl font-extrabold tabular-nums" style={{ color: '#4ade80' }}>91</div>
              </div>
              <div className="space-y-4 sm:space-y-5">
                {([
        ...
        <ScrollReveal delay={200}>
          <p className="text-center text-xs text-slate-600 mt-4 sm:mt-5 px-4">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-24">
        <ScrollReveal className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-slate-400 text-sm sm:text-base">No forms. No questionnaires. Paste and go.</p>
        </ScrollReveal>

        <div className="relative grid sm:grid-cols-3 gap-4 sm:gap-6">
          {/* Connector line (desktop) */}
          <div className="hidden sm:block absolute top-16 left-[calc(33.33%+12px)] right-[calc(33.33%+12px)] h-px z-0"
          ...
          {([
            ...
            <ScrollReveal key={num} delay={delay} direction="up">
              <div
                className="group relative gradient-border rounded-2xl p-5 sm:p-7 h-full transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
                style={{ background: '#0f1629' }}
              >
                <div
                  className="text-6xl sm:text-7xl font-extrabold mb-2 sm:mb-3 leading-none select-none transition-all duration-500 group-hover:opacity-20"
                  style={{ color: 'rgba(124,58,237,0.13)', fontVariantNumeric: 'tabular-nums' }}
                >
                  {num}
                </div>
                <div className="relative w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center mb-4 sm:mb-5">
                  ...
                  <Icon className="relative w-4 h-4 sm:w-5 sm:h-5 text-purple-400 transition-all duration-300 group-hover:scale-110 group-hover:rotate-6" />
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <ScrollReveal className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-slate-400 text-sm sm:text-base px-2">
              From Bengaluru startups to TCS/Infosys to IIM campus placements — we&apos;ve got you.
            </p>
          </ScrollReveal>

          <div className="grid grid-cols-3 gap-4 sm:gap-10 mb-10 sm:mb-14">
            {([
              ...
              <ScrollReveal key={label} delay={delay} className="text-center">
                ...
                <div className="text-xs text-slate-500 hidden sm:block">{sub}</div>
              </ScrollReveal>
            ))}
          </div>
          ...
          <ScrollReveal delay={300}>
            <div className="flex flex-wrap justify-center gap-2">
              {[
                ...
                <span
                  key={tag}
                  className="text-xs sm:text-sm px-3 sm:px-4 py-1.5 sm:py-2 rounded-full transition-all duration-300 hover:-translate-y-0.5 hover:border-purple-500/40 hover:text-slate-200 cursor-default"
                  style={{
                    background: 'rgba(255,255,255,0.04)',
                    border: '1px solid rgba(255,255,255,0.08)',
                    color: '#94a3b8',
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          ...
          <ScrollReveal delay={0} direction="up">
            <div className="group gradient-border rounded-2xl p-5 sm:p-6 h-full transition-all duration-300 hover:-translate-y-2 hover:shadow-xl sm:col-span-2 lg:col-span-1"
              style={{ background: '#0f1629' }}>
              ...
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed mb-4">
                We extract role-critical keywords and weave them naturally into your resume — so ATS filters stop rejecting you.
              </p>
              <div className="flex flex-wrap gap-1.5">
                {['React', 'Project Mgmt', 'REST APIs', 'Agile', 'CI/CD'].map((kw, i) => (
                  <span
                    key={kw}
                    className="text-xs px-2 py-1 rounded-md"
                    style={{ background: 'rgba(124,58,237,0.15)', color: '#a78bfa', animationDelay: `${i * 80}ms` }}
                  >
                    {kw}
                  </span>
                ))}
          ...
          <ScrollReveal delay={80} direction="up">
            <div className="group gradient-border rounded-2xl p-5 sm:p-6 h-full transition-all duration-300 hover:-translate-y-2 hover:shadow-xl"
              style={{ background: '#0f1629' }}>
              <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center mb-4 transition-all duration-300 group-hover:scale-110 group-hover:rotate-6"
                style={{ background: 'rgba(124,58,237,0.15)' }}>
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2 text-xs p-2 sm:p-2.5 rounded-lg"
                ...
                <div className="flex items-start gap-2 text-xs p-2 sm:p-2.5 rounded-lg"
                  ...
                  <span className="text-slate-300">Built 4 Spring Boot microservices, cut latency 42%</span>
                </div>
              </div>
            </div>
          </ScrollReveal>
      ...
      <ScrollReveal>
        <section className="py-16 sm:py-28 relative overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto px-4 text-center">
            ...
            <p className="text-slate-400 mb-8 sm:mb-10 text-sm sm:text-lg max-w-xl mx-auto">
      ...
      <footer className="border-t border-white/[0.06] py-10 sm:py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-between sm:gap-8 mb-6 sm:mb-8">
            <div className="flex items-center gap-2">
              <img src="/logo.png" alt="HireWin Logo" className="w-7 h-7 sm:w-8 sm:h-8 object-contain animate-glow-pulse" />
            ...
            <div className="flex flex-wrap justify-center gap-x-5 sm:gap-x-8 gap-y-2 text-xs sm:text-sm text-slate-500">
              ...
              <Link href="/analyze" className="hover:text-slate-300 transition-colors">Resume Optimizer</Link>
          ...
          <div className="text-center text-xs text-slate-600 border-t border-white/[0.04] pt-6 sm:pt-8">
