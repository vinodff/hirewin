...
function parseResume(text: string): ParsedSection[] {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (isFirst && trimmed) {
      ...
      isFirst = false;
      // Collect next few short lines as contact info
      let j = i + 1;
      while (j < lines.length && j <= i + 4) {
        const nextTrimmed = lines[j].trim();
        if (!nextTrimmed) { j++; continue; }
        // Contact lines are typically short with email/phone/links
        if (
...
/* ── Render functions per template style ───── */
      ...
      return (
        <div style={{ marginTop: '12px', marginBottom: '4px' }}>
          <div style={{
            ...
            fontSize: '12px',
            fontWeight: 700,
            color: tpl.sectionTitleColor,
            letterSpacing: '1.5px',
            paddingBottom: '2px',
            borderBottom: `1.5px solid ${tpl.accentBorder}`,
          }}>
            {text}
          </div>
        </div>
    ...
    case 'bg-band':
      return (
        <div style={{
          marginTop: '12px',
          marginBottom: '4px',
          background: `${tpl.sectionTitleColor}12`,
          padding: '4px 8px',
          borderLeft: `3px solid ${tpl.sectionTitleColor}`,
        }}>
          <div style={{
            fontFamily: tpl.fontFamily,
            fontSize: '11px',
      ...
      return (
        <div style={{
          ...
          <div style={{
            ...
            height: '16px',
            borderRadius: '2px',
            background: `linear-gradient(180deg, ${tpl.accentColor}, ${tpl.accentColor}80)`,
          }} />
          <div style={{
            fontFamily: tpl.fontFamily,
            fontSize: '11px',
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          background: `linear-gradient(180deg, ${tpl.accentColor}25, ${tpl.accentColor}10)`,
          padding: '10px',
        }}
      >
        <div
          ...
          style={{
            maxHeight: '720px',
            background: tpl.paperBg,
            aspectRatio: '8.5 / 11',
            maxWidth: '100%',
            boxShadow: tpl.paperShadow,
            borderRadius: '2px',
          }}
        >
    ...
    <>
      {sections.map((section, i) => {
        switch (section.type) {
            ...
            return (
              <div
                ...
                style={{
                  ...
                  fontSize: '9px',
                  color: tpl.headerBg ? '#ffffff90' : '#6b7280',
                  textAlign: tpl.headerAlign,
                  ...(tpl.headerBg
                    ? { margin: '-20px -48px 16px -48px', padding: '0 48px 16px', background: tpl.headerBg }
                    : { marginBottom: '12px' }),
                  letterSpacing: '0.3px',
                }}
              >
          ...
          case 'section-title':
            return (
              <div key={i}>{renderSectionTitle(section.text, tpl)}</div>
            );
          case 'content':
            return (
              <div
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100%' }}>
      ...
      <div
        style={{
          width: '35%',
          background: tpl.headerBg || '#064e3b',
          padding: '28px 16px',
          color: '#ffffff',
        }}
      >
